...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String freeSpace = String.format(Locale.US, "%1.2f", (this.getFilesDir().getFreeSpace() - WallpaperManager.MINIMUM_REQUIRED_FREE_SPACE) / (1024.0 * 1000000));
        String totalSpace = String.format(Locale.US, "%1.2f", (this.getFilesDir().getTotalSpace() - WallpaperManager.MINIMUM_REQUIRED_FREE_SPACE) / (1024.0 * 1000000));
